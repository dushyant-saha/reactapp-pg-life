            ...
            <div className='link-container'>
                ...
                <div className='city-list'>
                    <div className='city-card-container'>
                        <Link className=""><div className='city-card rounded-circle delhi'><img src={delhi} alt='Delhi' /></div></Link>
                    </div>
                    <div className='city-card-container'>
                        <Link className=""><div className='city-card rounded-circle mumbai'><img src={mumbai} alt='Mumbai' /></div></Link>
                    </div>
                    <div className='city-card-container'>
                        <Link className=""><div className='city-card rounded-circle bangalore'><img src={bangalore} alt='Bangalore' /></div></Link>
                    </div>
                    <div className='city-card-container'>
                        <Link className=""><div className='city-card rounded-circle chennai'><img src={chennai} alt='Chennai' /></div></Link>
                    </div>
                </div>
            </div>
        </section>
